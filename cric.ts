...
class Player1{
  ...
  let countDownDate = new Date().getTime()+12000; 
    ...
    if(i==10)
    {
     ...
     (document.getElementById('p2button') as HTMLInputElement).disabled = false;
 ...
 if(clicks<2)
 {
  ...
  let balls=[["p1b1","p1b2","p1b3","p1b4","p1b5","p1b6","total1"],["p2b1","p2b2","p2b3","p2b4","p2b5","p2b6","total2"],
...
let countDownDate = new Date().getTime()+12000; 
  ...
  {
   //(document.getElementById('p1button') as HTMLInputElement).disabled = true;
   (document.getElementById('p2button') as HTMLInputElement).disabled = true;
...
let balls1=[["t2p1b1","t2p1b2","t2p1b3","t2p1b4","t2p1b5","t2p1b6","t2total1"],["t2p2b1","t2p2b2","t2p2b3","t2p2b4","t2p2b5","t2p2b6","t2total2"],
...
function generate()
{
   ...
   if(runcount1>runcount2){
    alert("team1 is winner");
  }
  else{
    alert("team 2 is winner");
  }
}
